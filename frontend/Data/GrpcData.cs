...
namespace SecondVariety
{
  ...
  public class GrpcClientService
  {
    ...
    private SecondVariety.Models.Object ObjectFromGObject(GObject obj)
    {
      ...
      {
        var msg = e.Message;
        _logger.LogInformation($"ObjectFromGObject : {msg.ToString()} , {e.InnerException?.Message.ToString()??""}");
         
      }
      return new SecondVariety.Models.Object() ;
    }
    ...
    {
      var dt = DateTime.SpecifyKind(tstmp?.ToDateTime()??DateTime.MinValue, DateTimeKind.Local);
      return dt;
    ...
    {
      var dt = DateTime.SpecifyKind(tstmp?.ToDateTime()??DateTime.MinValue, DateTimeKind.Unspecified);
      return dt;
    }
    ...
    {
      return Timestamp.FromDateTime(DateTime.SpecifyKind(dt?.ToUniversalTime()??DateTime.MinValue, DateTimeKind.Utc));
    }
